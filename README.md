...
A Calculadora de Notas tem como finalidade informar a média informada pelo usuário. Válido lembrar que o usuário pode adicionar ou remover a quantidade de notas para o cálculo da média.
